...
//Garrison work start
PROJECT OVERVIEW:
This text-based adventure game is going to be set in an enclosed map, where the player explores a generated maze-like structure.
The player will use text commands to make decisions. Things like movement and actions will be checked for exceptions after each move to prevent unintended behavior.
